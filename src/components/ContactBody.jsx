    ...
    <section className="w-full py-16 bg-white mt-6 md:mt-16">
      <div className="container mx-auto px-[150px]">
        ...
        <div className="text-center my-10">
          <h2 className="text-6xl text-black font-bold mb-4">Feel free to get in touch</h2>
          <p className="text-lg text-black w-[600px] text-center mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12 py-16">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            <h3 className="text-4xl text-black font-bold mb-4">Don't hesitate to contact us</h3>
